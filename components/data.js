...
export const Skills = [
  {
    icon: <Icon as={FaReact} w={10} h={10} color="blue" />,
    title: "React",
    description:
  ...
  {
    icon: <Icon as={FaNodeJs} w={10} h={10} color="green" />,
    title: "NodeJS",
    description:
  ...
  {
    icon: <Icon as={SiExpressServer} w={10} h={10} color="green" />,
    title: "Express",
    description:
  ...
  {
    icon: <Icon as={SiMongodb} w={10} h={10} color="green" />,
    title: "MongoDB",
    description:
  ...
  {
    icon: <Icon as={SiRedux} w={10} h={10} color="purple" />,
    title: "Redux",
    description:
  ...
  {
    icon: <Icon as={SiNextdotjs} w={10} h={10} color="grey" />,
    title: "NextJS",
    description:
  ...
  {
    icon: <Icon as={SiPostgresql} w={10} h={10} color="blue" />,
    title: "Postgres",
    description:
  ...
  {
    icon: <Icon as={SiSocketdotio} w={10} h={10} color="grey" />,
    title: "Socket.io",
    description:
  ...
  {
    icon: <Icon as={SiJest} w={10} h={10} color="orange" />,
    title: "Jest",
    description:
  ...
  {
    icon: <Icon as={FaSass} w={10} h={10} color="red" />,
    title: "Sass",
    description:
  ...
  {
    icon: <Icon as={FaReact} w={10} h={10} color="orange" />,
  ...
  {
    icon: <Icon as={SiHtml5} w={10} h={10} color="orange" />,
    title: "HTML",
    description:
  ...
  {
    icon: <Icon as={SiCss3} w={10} h={10} color="blue" />,
    title: "CSS",
    description:
